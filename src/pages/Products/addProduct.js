...
const ProductUpload = () => {
  ...
  const inputChange = (e) => {
    ...
    if (name === 'price' || name === 'oldPrice') {
      // Remove any non-numeric characters and prepend '$'
      let numericValue = value.replace(/[^0-9]/g, '');
      displayValue = `$${numericValue}`; // Prepend '$' for price inputs

      setFormFields((prevFields) => ({
        ...prevFields,
        [name]: numericValue, // Store only the numeric value in the state
      }));
    } else if (name === 'discount') {
      // Remove any non-numeric characters and append '%'
      let numericValue = value.replace(/[^0-9]/g, '');
      displayValue = `${numericValue}%`; // Append '%' for discount
      ...
      displayValue = value; // Keep the original value for other inputs
      setFormFields((prevFields) => ({
        ...prevFields,
        [name]: value,
      }));
                  ...
                  <div className="col">
                    <div className="form-group">
                      ...
                      <input
                        type="text"
                        name="price"
                        value={`$${formFields.price || ''}`}  // Show $ before the value, but exclude from state
                  ...
                  <div className="col">
                    <div className="form-group">
                      ...
                      <input
                        type="text"
                        name="oldPrice"
                        value={`$${formFields.oldPrice || ''}`}  // Show $ before the value, but exclude from state
                  ...
                  <div className="col-md-4">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        name="discount"
                        placeholder="%"
                        value={`${formFields.discount || ''}%`}  // Show the numeric value followed by %
                        onChange={inputChange}
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-md-4">
                    <div className="form-group">
                      ...
                      <Select
                        ...
                        className="w-100"
                      >
                        {Array.isArray(productRAMSData) && productWEIGHTData?.map((item, index) => {
                          return (
                  ...
                  <div className="col-md-4">
                    <div className="form-group">
                      ...
                      <Select
                        ...
                        className="w-100"
                      >
                        {Array.isArray(productRAMSData) && productSIZEData?.map((item, index) => {
                          return (
